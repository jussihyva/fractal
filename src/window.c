...
/*   Updated: 2021/06/28 19:03:46 by jkauppi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	window_initialize(t_window *window, char *window_name)
{
	...
	mlx_hook(window->win, 2, 0x00, keyboard_key_press, window);
	mlx_hook(window->win, 4, 0x00, mouse_button_press, window);
	mlx_hook(window->win, 6, 0x00, mouse_motion_notify, window);
